...
\nomenclature{\(\left(L_t,L_{\mathcal{E},i},L_k,L_{0,i}\right) (\bar{\x})\)}{The Lagrangian multiplier polynomials}%
...
\nomenclature{\(\mathcal{X}_0\)}{The initial state set}%
\nomenclature{\(\mathcal{X}_{end}\)}{The goal state set}%
