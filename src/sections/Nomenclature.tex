\nomenclature{\(\vect{x}\)}{The state vector}%
\nomenclature{\(\bar{\vect{x}}\)}{The state error vector}%
\nomenclature{\(\vect{u}\)}{The input vector}%
\nomenclature{\(\bar{\vect{u}}\)}{The input error vector}%
\nomenclature{\(\vect{w}\)}{The noise vector}%
\nomenclature{\(\rho\)}{The upper bound on the Sum of Squares optimization}%
\nomenclature{\(V\)}{The Lyapunov function}%
\nomenclature{\(\left(L_t,L_{\mathcal{E},i},L_k,L_{0,i}\right) \)}{The Lagrangian multiplier polynomials}%
\nomenclature{\modelworld}{The world model}%
\nomenclature{\modelrobot}{The robot model}%
\nomenclature{\modelobstacle}{The model obstacles}%
\nomenclature{\modelactionspace}{The action space}%
\nomenclature{\modelconfigurationspace}{The configuration space}%
\nomenclature{\modelconfigurationspacesub}{A subspace of the configuration space}%
\nomenclature{\modelconfigurationspacefree}{The collision free parts of the configuration space}%
\nomenclature{\modelconfigurationspaceobst}{The parts of the configuration space occupied by obstacles}%
\nomenclature{\(\mathcal{X}_{0}\)}{The initial state set}%
\nomenclature{\(\mathcal{X}_{\mathit{end}}\)}{The goal state set}%
\nomenclature{\(F(t)\)}{The finite time funnel}%
\printnomenclature
%
