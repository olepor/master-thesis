...
The initial trajectory set is pictured in~\ref{fig:intial-trajectories}, and
...
where \(P \colon \R^4 \rightarrow \R^2\) is a projection map with a
projection matrix 
\[
  P =
  \begin{bmatrix}
...
A collection of the added motion primitives is shown in~(\ref{fig:expanded-motion-primtives}).
