...
The planning algorithm used in this thesis will built upon the \textit{\acl{RRT}} algorithm, which was first proposed by
\cite[LaValle]{article}. The \ac{RRT} algorithm.
