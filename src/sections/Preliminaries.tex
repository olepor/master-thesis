...
search for a Lyapunov function candidate that parametrizes the reachable set for
...
in computing the funnels, but the parametrization of the funnels will be
