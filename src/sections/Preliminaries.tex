...
\eqref{eq:model-dynamics} on~\pageref{eq:model-dynamics} (which is a simple
...
\cref{alg:funnelalgorithm} on~\pageref{alg:funnelalgorithm} for computing
funnels.
...
\begin{figure}
  \begin{minipage}[c]{0.3\textwidth}
    \includegraphics[width=.9\textwidth]{plainRRT10}
    \subcaption{\(10\) iterations.}
  \end{minipage}
  \begin{minipage}[c]{0.3\textwidth}
    \includegraphics[width=.9\textwidth]{plainRRT50}
    \subcaption{\(50\) iterations.}
  \end{minipage}
  \begin{minipage}[c]{0.3\textwidth}
    \includegraphics[width=.9\textwidth]{plainRRT100}
    \subcaption{\(100\) iterations.}
  \end{minipage}
  \newline % Start the new line of plainRRT10.
  \begin{minipage}[c]{0.3\textwidth}
    \includegraphics[width=.9\textwidth]{plainRRT500}
    \subcaption{\(500\) iterations.}
  \end{minipage}
  \begin{minipage}[c]{0.3\textwidth}
    \includegraphics[width=.9\textwidth]{plainRRT1000}
    \subcaption{\(1000\) iterations.}
  \end{minipage}
  \begin{minipage}[c]{0.3\textwidth}
    \includegraphics[trim={2cm 1cm 2cm 1cm}, clip, width=.9\textwidth]{plainRRT10000}
...
When inspecting the Voronoi regions of a \acl{RRT} tree it is apparent that the
...
\begin{figure}
  \centering \frame{\includegraphics[clip, trim=5cm 9cm 5cm 9cm,
    scale=.6]{figures/rrt/rrtvoronoi}}
