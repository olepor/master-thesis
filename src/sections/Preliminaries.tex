...
\[
  ...
  \mathcal{X}_{end} = \set{ x \in \modelconfigurationspace{} \mid g_i(x) \leq a_i,
...
\begin{mini*}[1]
    ...
    \addConstraint{}{}{\quad \forall k \in \set{1, \ldots, N}.}
\end{mini*}
...
\begin{mini}
  ...
  {\sum_{k=1}^{N}\vol(\mathcal{E}(t_{k})) = \sum_{k=1}^{N}
    \vol\left( \set{\bar{x} \mid {\bar{x}}^{T} S_{k} \bar{x} \leq 1}
